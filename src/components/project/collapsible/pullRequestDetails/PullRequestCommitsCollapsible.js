 ...
 */
const PullRequestCommitsCollapsible = ({ pullRequest }) => {
    
    const getNumberStyles = () => ({
        width: "2rem",
        height: "27px",
        marginRight: "1rem",
        backgroundColor: (pullRequest.commits && pullRequest.commits.length > 0)
            ? "green" : "red",
        textAlign: "center",
        color: "white",
        borderRadius: "0.5rem"
            ...
            <div className="collapsible-header" style={styleCollapsibleHeader}>
                <div style={styleCollapsibleHeaderText}>
                    <div style={getNumberStyles()}>
                        {pullRequest.commits && pullRequest.commits.length}
                    </div>
                    Commits
                </div>
            </div>
...
export default PullRequestCommitsCollapsible;